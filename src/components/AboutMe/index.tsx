        ...
        <Section bg='brand.backgroundSecondary' id='about-me' ref={ref}>
            <Flex css={styles.aboutMeContainer}>
                <Box css={styles.detailsBox}>
                    ...
                    <br />
                    <Text fontSize='2xl' fontWeight={600} color='brand.textSecondary'>
                        Now, I specialize in developing modern web applications using Nextjs, React, and Typescript.
                        My goal is to continue learning and expanding my knowledge to gain full-stack abilities, allowing me to have an overview of how everything works together.
