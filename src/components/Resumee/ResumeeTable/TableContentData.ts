...
export const Jobs: TableContentDetail[] = [
    {
        ...
        place: 'Freelance - Berlin, Germany',
        description: 'Content creation for Youtube, Twitch, Tiktok and Instagram for personal and clients accounts. Social Media management',
