...
interface useInputObject {
    ...
    isValid: boolean,
    hasError: boolean,
    onChangeHandler: (e: React.FormEvent<HTMLInputElement> | React.FormEvent<HTMLTextAreaElement>) => void,
    onBlurHandler: (e: React.FormEvent<HTMLInputElement> | React.FormEvent<HTMLTextAreaElement>) => void,
    reset: () => void
}
